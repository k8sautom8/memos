  ...
  return (
    <>
      ...
      */}
      <div
        className={cn(
          "group relative w-full flex flex-col justify-between items-start",
          !isDark && "bg-card",
          // Apple-style spacing: generous padding on mobile, refined on desktop
          "px-3 py-3 sm:px-4 sm:pt-3 sm:pb-2 md:px-5 md:pt-4 md:pb-3",
          "rounded-xl sm:rounded-lg",
          !isDark && "border border-border/60",
          !isDark && "shadow-sm ring-1 ring-border/30",
          "transition-all duration-300 ease-out",
          !isDark && "hover:shadow-md hover:ring-border/50",
      ...
      >
        ...
        <div className="w-full flex flex-col gap-3 sm:gap-2.5 md:gap-2 min-w-0">
          <EditorMetadata />
