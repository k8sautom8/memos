...
- **AI Integration:** Ollama-compatible models for tag generation and writing assistance
- **Features:** Comments, text-to-speech, customizable templates, ConfigMap support
...
| `OLLAMA_BASE_URL` | `http://localhost:11434` | Ollama API base URL for AI features |
| `OLLAMA_MODEL` | `gpt-oss:120b` | Default Ollama model for AI features |
